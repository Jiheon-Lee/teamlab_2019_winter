...
class Comments(models.Model):
    ...
    theaterid = models.ForeignKey('Theaters', on_delete=models.CASCADE, db_column='TheaterID')  # Field name made lowercase.
...
class TheatersDetails(models.Model):
    theaterid = models.OneToOneField(Theaters, on_delete=models.CASCADE, db_column='TheaterID', primary_key=True)  # Field name made lowercase.
